...
pacstrap -d /mnt base linux linux-firmware cloud-guest-utils cloud-init openssh os-prober qemu-guest-agent sudo systemd-resolvconf grub btrfs-progs iptables-nft kubeadm kubelet kubectl cni-plugins crictl cri-o ${EXTRA_PACKAGES}
